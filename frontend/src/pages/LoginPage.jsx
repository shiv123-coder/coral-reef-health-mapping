      ...
      <div className="main" style={{ flex: 1, display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(400px, 1fr))', gap: 28, padding: '44px 44px 20px', position: 'relative', zIndex: 2, alignItems: 'center' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <form id="loginForm" onSubmit={handleLogin} noValidate style={{
            ...
            <div style={{
              width: 78, height: 78, borderRadius: '50%', margin: '0 auto 22px', background: isDarkMode ? 'rgba(59,158,255,0.1)' : 'rgba(59,158,255,0.05)', border: '1px solid rgba(79,214,232,0.35)', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 0 0 8px rgba(79,214,232,0.04)'
            }}>
