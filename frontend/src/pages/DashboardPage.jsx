      ...
      <main className="main" style={{ padding: '26px 30px 40px', overflowX: 'hidden', background: 'var(--bg-deep)' }}>
        <div style={{ display: 'flex', justifyContent: 'flex-end', alignItems: 'center', gap: 16, marginBottom: 26 }}>
          ...
          <div style={{ position: 'relative', width: 40, height: 40, borderRadius: 11, background: 'var(--card)', border: '1px solid var(--card-border)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--text-dim)', cursor: 'pointer' }}>
            ...
            <span style={{ position: 'absolute', top: -4, right: -4, background: 'var(--red)', color: '#fff', fontSize: 10, fontWeight: 700, width: 17, height: 17, borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', border: '2px solid var(--bg-deep)' }}>3</span>
          </div>
        </div>
