        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: 16, marginBottom: 16 }}>
          ...
          <div style={{ background: 'var(--card)', border: '1px solid var(--card-border)', borderRadius: 16, padding: 22 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
              ...
              <button onClick={() => navigate('/map')} style={{ background: 'var(--input-bg)', border: '1px solid var(--card-border)', borderRadius: 12, padding: 14, display: 'flex', gap: 8, cursor: 'pointer', color: 'var(--text)', gridColumn: '1 / -1', flexDirection: 'row', alignItems: 'center' }}>
